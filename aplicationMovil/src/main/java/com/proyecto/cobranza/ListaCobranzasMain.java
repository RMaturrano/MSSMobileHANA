...
import com.proyecto.utils.PagerAdapterListCobranzas;

public class ListaCobranzasMain extends Fragment{

	
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup,
			Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.lista_cobranzas_cliente, viewGroup,
				false);
		...
		final PagerAdapterListCobranzas adapter = new PagerAdapterListCobranzas(
