...
public class ListViewCustomAdapterTwoLinesAndImgWithFormat extends BaseAdapter implements Filterable{
    ...
    public LayoutInflater inflater;
    																					...
    																					//int[] image
    public ListViewCustomAdapterTwoLinesAndImgWithFormat(Context context,ArrayList<FormatCustomListView> lista) {
        super();
