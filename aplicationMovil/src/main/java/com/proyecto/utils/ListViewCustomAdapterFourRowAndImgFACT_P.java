...
public class ListViewCustomAdapterFourRowAndImgFACT_P extends BaseAdapter implements Filterable{
    ...
    public ListViewCustomAdapterFourRowAndImgFACT_P(Context context,ArrayList<FacturaBean> lista) {
        super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            convertView = inflater.inflate(R.layout.custom_four_row_and_img_lst_fact_pag, null);
