...
import com.proyecto.sociosnegocio.SocioNegocioFragment;
    ...
    public static void enableStrictMode() {
        ...
        if (Utils.hasGingerbread()) {
            ...
            if (Utils.hasHoneycomb()) {
                ...
                vmPolicyBuilder
                        .setClassInstanceLimit(SocioNegocioFragment.class, 1)
                        .setClassInstanceLimit(DetalleSocioNegocioMainFTabs.class, 1);
            }
