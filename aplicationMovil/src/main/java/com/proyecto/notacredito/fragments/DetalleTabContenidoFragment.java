...
public class DetalleTabContenidoFragment  extends Fragment implements IRVAdapterDetalleNotaCredito {
    ...
    public void onStart() {
        ...
        if(mDevolucion != null){
            ...
            for (NotaCreditoDetalleBean d: mDevolucion.getLineas()) {
                items.add(new ItemDetailModelNC("Cantidad: " + d.getCantidad(), d.getArticuloNombre(), false));
            }
