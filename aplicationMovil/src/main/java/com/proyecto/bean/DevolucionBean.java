...
public class DevolucionBean implements Parcelable {
    ...
    private List<DevolucionDetalleBean> Lineas;
    ...
    public List<DevolucionDetalleBean> getLineas() {
        return Lineas;
    }

    public void setLineas(List<DevolucionDetalleBean> lineas) {
        Lineas = lineas;
    }
    ...
    public static JSONObject transformDevolucionToJSON(DevolucionBean bean, String sociedad){
        ...
        try{
            ...
            for (DevolucionDetalleBean line: bean.getLineas()) {
                JSONObject jsonLine = new JSONObject();
                jsonLine.put("ClaveDevolucion", line.getClaveDevolucion());
                ...
                if(line.getLotes() != null) {
                    ...
                    for (DevolucionDetalleLoteBean l : line.getLotes()) {
    ...
    protected DevolucionBean(Parcel in) {
        Tipo = in.readString();
        clave = in.readString();
        ...
        if (in.readByte() == 0x01) {
            Lineas = new ArrayList<DevolucionDetalleBean>();
            in.readList(Lineas, DevolucionDetalleBean.class.getClassLoader());
        } else {
            Lineas = null;
        }
    }
    ...
    public static final Parcelable.Creator<DevolucionBean> CREATOR = new Parcelable.Creator<DevolucionBean>() {
        @Override
        public DevolucionBean createFromParcel(Parcel in) {
            return new DevolucionBean(in);
        }

        @Override
        public DevolucionBean[] newArray(int size) {
            return new DevolucionBean[size];
        }
    };
}